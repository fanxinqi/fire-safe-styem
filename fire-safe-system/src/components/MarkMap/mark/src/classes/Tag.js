...
class Tag extends EventEmitter {
   ...
   * @param {Object} [tagAttributes = {}] - The button’s attributes
   * @param {Object} [popupAttributes = {}] - The popup’s attributes
   */
  constructor(position, text, tagAttributes = {}, popupAttributes = {}, elementName) {
    ...
    this.setTagAttributes(tagAttributes);
  ...
  enableEditorMode() {
    ...
    if (!isCanceled) {
      ...
      this.buttonElement.addEventListener('mousedown', (e) => {
        this.tagDownHander = this.tagDownHander.bind(this);
        // this.tagDownHander.call(this);
  ...
  toJSON() {
    ...
    return {
      ...
      text: this.text,
      tagAttributes: getAttributes(this.buttonElement.attributes),
  ...
  static createFromObject(object) {
    return new Tag(object.position, object.text, object.tagAttributes, object.popupAttributes);
  }
}
